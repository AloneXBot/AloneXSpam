...
Deadly_Button = [
        [
        Button.url("Cʜᴀɴɴᴇʟ", "https://t.me/The_Alone_Network"),
        Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/The_Alone_Network")
        ],
        [
        Button.url("• Rᴇᴘᴏ •", "https://telegra.ph/file/95b8a5320ceeb942b05eb.mp4")
        ]
        ]
